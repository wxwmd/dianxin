package com.ms.kafkaproducer.bean;



import com.ms.common.bean.DataIn;
import com.ms.common.bean.DataOut;
import com.ms.common.bean.Producer;
import com.ms.common.util.DateUtil;
import com.ms.common.util.NumberUtil;
 ...
 * 本地数据文件生产者
 */
public class KafkaCallRecordProducer implements Producer {
    ...
    public void produce() {
        ...
        try {
            ...
            while ( flg ) {
                ...
                System.out.println("生成数据："+log.toString());
                // 将通话记录刷写到数据文件中
                out.write(log);
